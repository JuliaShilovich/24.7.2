...
class PetFriends:
    ...
    def get_api_key(self, email: str, password: str) -> json:
        ...
        пользователя, найденного по указанным email и password'''
        head = {
            'email' : email,
            'password' : password,
        }
        res = requests.get(self.base_url+'api/key', headers=head)
    ...
    def update_pet_info(self, auth_key: json, pet_id: str, name: str,
        ...
        возвращает статус запроса и result в формате JSON с обновленныи данными питомца"""
    ...
    def add_new_pet_without_photo(self, auth_key: json, name: str, animal_type: str,
                    age: str) -> json:
        """Метод отправляет (постит) на сервер данные о добавляемом питомце и возвращает статус
        запроса на сервер и результат в формате JSON с данными добавленного питомца. Данный метод не содержит добавление фото"""
    ...
    def add_pet_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет запрос на сервер о добавлении фото по указанному ID и
        возвращает статус запроса и result в формате JSON с обновленныи данными питомца"""
